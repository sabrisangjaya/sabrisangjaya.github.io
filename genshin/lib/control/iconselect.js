...
IconSelect.DEFAULT.SELECTED_BOX_PADDING_RIGHT = 2;
...
function IconSelect($$elementID, $$parameters) {
    ...
    _View.createUI = function($parameters){
        ...
        */
        ...
        _View.iconSelectElement.style.display = "inline-block";
        _View.iconSelectElement.style.width = "auto";
        ...
        selectedBoxElement.style.width = $parameters.selectedIconWidth + $parameters.selectedBoxPadding;
        ...
        _View.boxScrollElement.style.top = parseInt(selectedBoxElement.style.height) + 301;
        ...
        _View.boxElement.style.top = _View.boxScrollElement.style.top;
